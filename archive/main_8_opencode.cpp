...
// // TODO: 填写实际引脚号
// uint8_t servos_pin[SERVO_NUM]       = { 0,   0,   0,   0,   0,   0,   0,   0 };
// //                           大腿:左前 右前 左后 右后 | 膝盖:左前 右前 左后 右后
// int servo_correction[SERVO_NUM]     = { 0,   0,   0,   0,   0,   0,   0,   0 };
// //                           true=同向  false=反向
...
//     int tmp = servos[servo_index].read() - 90;
//     if (angle > tmp) {
//         for (int agl = tmp; agl <= angle; agl++) {
...
// // ============= Trot 步态 =============
// #define TROT_THIGH   30
// #define TROT_KNEE    30
// #define TROT_PAUSE   290
...
// // ============= Walk 步态 =============
// #define WALK_THIGH   40
// #define WALK_KNEE    30
// #define WALK_LEG_DT  250
